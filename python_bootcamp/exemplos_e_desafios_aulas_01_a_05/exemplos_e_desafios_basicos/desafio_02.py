...
def verifica_nome_do_usuário(nome_usuario):
    if nome_usuario.isdigit():
        print('\nO nome do usuários não pode conter números, apenas letras. Tente novamente.')
...
while True:
    ...
    # 5) Imprimir a mensagem personalizada incluindo o nome do usuário, salário, bônus e bônus final
    print('\n\n')
    print(f'Olá {usuario}.')
